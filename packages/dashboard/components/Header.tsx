...
export function Header() {
	// TODO: when an "ingestion-live" signal is wired up (e.g., a heartbeat row
	// the poller updates on each tick), reintroduce the live indicator via a
	// noStore'd query — pattern is preserved in v1's git history.
	return (

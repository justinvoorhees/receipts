 ...
 * collisions. Generalizes the token-pair-specific `smokeTrades` /
 * `routerTradesGated` columns (input/output token instead of USDC/WETH)
 * so receipts aren't limited to a single trading pair.
 *
